...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sanmudi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚，喜欢航模，骑行和爬山', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jiuqain.top', // 网站地址
